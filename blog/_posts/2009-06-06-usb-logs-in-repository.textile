...
The logs for the HEM-790IT blood pressure monitor were produced using http://www.usblyzer.com/:"USBLyzer". The HJ-720IT pedometer logs were produced using http://sourceforge.net/projects/usbsnoop/:"SnoopyPro". I've included the binary log files for these programs, as well as html or xml output of the raw USB, and CSV output from the Omron Health Management software. This is all the information I've needed so far to piece the protocols back together.
